...
class PaymentGateways
{
    public static $gateways = [
        ...
        'oney_x3_with_fees' => [
            ...
            'has_fields' => true,
            // Trailing space before the closing quote matches get_icon()'s own
            // 'payplug-payment-icon ' . $disable construction (empty $disable when available).
            'image' => '<img src="' . PAYPLUG_GATEWAY_PLUGIN_URL . '/assets/images/checkout/x3_with_fees.svg" alt="Oney 3x" class="payplug-payment-icon " />',
            'enable' => 'no',
            'enable_on_test_mode' => true,
        ],
        'oney_x3_without_fees' => [
            ...
            'method_description' => 'Enable PayPlug Oney 3x for your customers.',
            'has_fields' => true,
            // get_icon() picks a per-country SVG (falling back to _FR) via getISOCountryCode(),
            // so this fixture only matches when the test environment's locale resolves to FR.
            'image' => '<img src="' . PAYPLUG_GATEWAY_PLUGIN_URL . '/assets/images/checkout/x3_without_fees_FR.svg" alt="Oney 3x" class="payplug-payment-icon " />',
            'enable' => 'no',
            'enable_on_test_mode' => true,
        ],
        'oney_x4_with_fees' => [
            ...
            'has_fields' => true,
            'image' => '<img src="' . PAYPLUG_GATEWAY_PLUGIN_URL . '/assets/images/checkout/x4_with_fees.svg" alt="Oney 4x" class="payplug-payment-icon " />',
            'enable' => 'no',
            'enable_on_test_mode' => true,
        ],
        'oney_x4_without_fees' => [
            ...
            'method_description' => 'Enable PayPlug Oney 4x for your customers.',
            'has_fields' => true,
            // Same per-country caveat as oney_x3_without_fees above.
            'image' => '<img src="' . PAYPLUG_GATEWAY_PLUGIN_URL . '/assets/images/checkout/x4_without_fees_FR.svg" alt="Oney 4x" class="payplug-payment-icon " />',
            'enable' => 'no',
            'enable_on_test_mode' => true,
        ],
        'ideal' => [
