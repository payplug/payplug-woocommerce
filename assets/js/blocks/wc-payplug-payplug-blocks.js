...
/* harmony import */ var _wc_payplug_integratedPayment_blocks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./wc-payplug-integratedPayment-blocks */ "./resources/js/frontend/wc-payplug-integratedPayment-blocks.js");
...
const Content = props => {
  if (settings?.IP === true) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wc_payplug_integratedPayment_blocks__WEBPACK_IMPORTED_MODULE_4__["default"], {
      settings: settings,
      props: props
    });
  }
  if (settings?.popup === true) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wc_payplug_popup_blocks__WEBPACK_IMPORTED_MODULE_5__["default"], {
      settings: settings,
      props: props
    });
  }
...
const Payplug = {
  ...
  supports: {
    ...
    showSaveOption: settings?.save_card && settings?.IP,
