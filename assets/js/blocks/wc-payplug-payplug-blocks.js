  ...
  (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    const handlePaymentProcessing = async () => {
      ...
      await (0,_helper_wc_payplug_requests__WEBPACK_IMPORTED_MODULE_4__.getPayment)(props, settings, order_id).then(async response => {
        ...
        try {
          ObjIntegratedPayment.api.pay(ObjIntegratedPayment.paymentId, Payplug.Scheme.AUTO, {
        ...
        return new Promise((resolve, reject) => {
          try {
            ObjIntegratedPayment.api.onCompleted(function (event) {
              ...
              (0,_helper_wc_payplug_requests__WEBPACK_IMPORTED_MODULE_4__.check_payment)(data).then(res => {
                resolve(res);
              });
            });
          } catch (e) {
...
(0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_1__.registerPaymentMethod)(wc_payplug_blocks_Payplug);
/******/ })()
;
