...
class PayplugApplePay extends PayplugGenericBlock
{
    ...
    public function get_payment_method_data()
    {
        ...
        $data['payplug_countryCode'] = null !== WC()->customer ? WC()->customer->get_billing_country() : 'FR';
        ...
        $data['countryCode'] = null !== WC()->customer ? WC()->customer->get_billing_country() : 'FR';
    ...
    public function get_carriers()
    {
        ...
        $packages = null !== WC()->cart ? WC()->cart->get_shipping_packages() : null;
