...
class PayplugGateway extends WC_Payment_Gateway_CC
{
    ...
    public function admin_options()
    {
		...
		wp_enqueue_script('chunk-vendors.js', PAYPLUG_GATEWAY_PLUGIN_URL . 'assets/dist/js/chunk-vendors.js', [], PAYPLUG_GATEWAY_VERSION);
		...
		wp_localize_script('app.js', 'payplug_admin_config', array( 'ajax_url'      => admin_url('admin-ajax.php') ));
