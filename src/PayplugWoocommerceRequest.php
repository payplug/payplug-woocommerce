...
class PayplugWoocommerceRequest
{
    ...
    public function ajax_create_payment()
    {
        ...
        if ('payplug' === $payment_method || 'american_express' === $payment_method) {
    ...
    public function check_payment()
    {
        ...
        if ((isset($payment->failure)) && (!empty($payment->failure)) || (false === $payment->is_paid && is_null($payment->paid_at))) {
    ...
    public function create_payment_intent()
    {
        ...
        if ('integrated' === $this->gateway->get_option('payment_method') && 'payplug' === $this->gateway->id) {
            $payment_data['initiator'] = 'PAYER';
            $payment_data['integration'] = 'INTEGRATED_PAYMENT';
            unset($payment_data['hosted_payment']['cancel_url']);
        }

        if ('popup' === $this->gateway->get_option('payment_method') && 'american_express' === $this->gateway->id) {
            $payment_data['payment_method'] = $this->gateway->id;
        }
