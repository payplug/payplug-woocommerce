...
class Vue
{
    ...
    public function init()
    {
        if (PayplugWoocommerceHelper::user_logged_in()) {
            ...
            unset($this->options['payplug_live_key'], $this->options['payplug_test_key'], $this->options['payplug_password'], $this->options['payplug_merchant_id'], $this->options['client_data']);
    ...
    {
        $enable = (!empty($this->options['enabled']) && 'yes' === $this->options['enabled']) ? true : false;
            ...
            'options' => [
                ...
                'options' => [
                    [
                        ...
                        'checked' => true === $enable ? true : false,
                    ],
                    [
                        'value' => 0,
                        'label' => __('payplug_section_header_disable_label', 'payplug'),
                        'checked' => false === $enable ? true : false,
                    ],
                ],
            ],
        ];
    ...
    public function payplug_section_payment_methods($options = [])
    {
        ...
        return [
            ...
            'options' => [
                ...
                PaymentMethods::payment_method_amex(!empty($this->options) && 'yes' === $this->options['american_express']),
                PaymentMethods::payment_method_applepay(!empty($this->options) && 'yes' === $this->options['apple_pay'], $this->options, $carriers),
                PaymentMethods::payment_method_bancontact(!empty($this->options) && 'yes' === $this->options['bancontact']),
                PaymentMethods::payment_method_satispay(!empty($this->options) && !empty($this->options['satispay']) && 'yes' === $this->options['satispay']),
                PaymentMethods::payment_method_mybank(!empty($options) && !empty($options['mybank']) && 'yes' === $this->options['mybank']),
                PaymentMethods::payment_method_ideal(!empty($this->options) && !empty($this->options['ideal']) && 'yes' === $this->options['ideal']),
            ],
        ];
    }
    ...
    public function payplug_section_paylater()
    {
        ...
        $product_page = !empty($this->options['oney_product_animation']) && 'yes' === $this->options['oney_product_animation'] ? true : false;
        ...
        return [
            ...
            'options' => [
                ...
                'checked' => !empty($this->options) && 'yes' === $this->options['oney'],
                'descriptions' => [
                    'live' => [
                ...
                'options' => [
                    [
                        ...
                        'value' => 'with_fees',
                        'checked' => !empty($this->options) && 'with_fees' === $this->options['oney_type'],
                    ],
                    [
                        'name' => 'payplug_oney_type',
                        'className' => '_paylaterLabel',
                        ...
                        'value' => 'without_fees',
                        'checked' => !empty($this->options) && 'without_fees' === $this->options['oney_type'],
                    ],
                ],
                'advanced_options' => [
    ...
    public function payplug_section_status($options = [])
    {
        ...
        $checked = !empty($options['debug']) && 'yes' === $options['debug'] ? true : false;
